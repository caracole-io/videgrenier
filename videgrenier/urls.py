...
urlpatterns = [
    ...
    path(
        "plan",
        TemplateView.as_view(template_name="videgrenier/plan.html"),
        name="plan",
    ),
    path(
        "reglement",
        TemplateView.as_view(template_name="videgrenier/reglement.html"),
        name="reglement",
    ),
    ...
    path(
        "reservation/<int:pk>/<int:accepte>",
        views.ReservationModerateView.as_view(),
        name="reservation-moderate",
    ),
